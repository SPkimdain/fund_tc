...
public class INTEGER_OVERFLOW_TestCase {
    ...
    public void safeTest2() throws IOException {
        Properties props = new Properties();
        String fileName = "file_list";
        FileInputStream in = new FileInputStream(fileName);
        props.load(in); /* BUG */ // Resource Leak
    ...
    public void safeTest3() throws IOException {
        Properties props = new Properties();
        String fileName = "file_list";
        FileInputStream in = new FileInputStream(fileName);
        props.load(in); /* BUG */ // Resource Leak
    ...
    public void arithmeticTest() {
        short data = (short) (new java.security.SecureRandom()).nextInt(1+Short.MAX_VALUE); /* BUG */ // dangerous downcast
