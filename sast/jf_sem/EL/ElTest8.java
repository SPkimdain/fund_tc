...
public class ElTest8 {
    ...
    public ElTest8() throws SQLException {
    ...
    el pattern : a.b
    */
    public void test8Driver(HttpServletRequest request) throws SQLException {
        Map map = new HashMap();
    ...
    public void test8Sink(Map map) throws SQLException {
        // map.get("user").get("name");
