...
:: 1. Folder list
set FOLDERS=binary_TC cocoapods_src conda dependency_TC go Gradle TC luarocks maven npm nuget pypi rna-star-debian-2.7.10b+dfsg-2 SPARROW-5676

:: Set user config
git config user.name "SPkimdain"
git config user.email "dain@fasoo.com"
